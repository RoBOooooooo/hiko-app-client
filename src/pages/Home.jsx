  ...
  return (
    <div>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900">
        ...
        {/* Hero Content */}
        <div className="container mx-auto px-4 py-20 lg:px-8 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              at your own pace, build new skills, and advance your career with
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Join thousands of learners who trust us to help them achieve their
              goals
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Study at your own pace, anytime and anywhere that suits you best",
              },
              {
                icon: (
                  <svg
                ...
                description:
                  "Access high-quality, up-to-date course materials and resources",
              },
              {
                icon: (
                  <svg
            ...
            {[
              {
                ...
                image: "https://i.ibb.co.com/7dPR8fMF/image.png",
                courses: "12 Courses",
              ...
              },
              {
                ...
                image: "https://i.ibb.co.com/1GCTXfbM/image.png",
                courses: "15 Courses",
                students: "12K+ Students",
              },
              {
                name: "Mushfique Raiyan",
                role: "Wordpress Professional",
                image: "https://i.ibb.co.com/PvRbMWkD/image.png",
                courses: "22 Courses",
              ...
              },
              {
                ...
                role: "UI/UX Designer",
                image: "https://i.ibb.co.com/677qxhbJ/image.png",
                courses: "18 Courses",
